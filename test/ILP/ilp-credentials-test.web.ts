...
import IlpWebCredentials from '../../src/ILP/auth/ilp-credentials.web'
...
describe('IlpCredentials Web', function(): void {
  it('Build - Undefined token', function(): void {
    ...
    const credentials = IlpWebCredentials.build()
  ...
  it('Build - no prefix', function(): void {
    ...
    const credentials = IlpWebCredentials.build(bearerToken)
