...
function dropsToXrp_deprecated(drops: BigNumber.Value): string {
...
function xrpToDrops_deprecated(xrp: BigNumber.Value): string {
...
export const XRPUtils = {
  dropsToXrp: dropsToXrp_deprecated,
  xrpToDrops: xrpToDrops_deprecated,
}
